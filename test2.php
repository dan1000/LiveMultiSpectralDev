<?php
	$slideindex = "";
	if (isset($_COOKIE["prev-slide"])) {
		$slideindex = $_COOKIE["prev-slide"];
		if (isset($_GET["slide-index-10"]) && ($_COOKIE["prev-slide"] != $_GET["slide-index-10"])) {
			setcookie("prev-slide", $_GET["slide-index-10"]);
		}	
	}
	else {
		if (isset($_GET["slide-index-10"])) {
			setcookie("prev-slide", $_GET["slide-index-10"]);
		}				
	}
	...
	$description="";
		...
		echo "<input name='filename' id='filename' type='hidden' value='".$startString."'>";				
...
<html>
	<head>
		...
		function demo1() {
			...
			Pixastic.process(document.getElementById("channel-1-img"), "apply_greyscale_threshold", {
			...
			Pixastic.process(document.getElementById("channel-11-img"), "apply_greyscale_threshold", {
				threshold: $("#value-threshold-1").val()
			});
		...
		function demo2() {
			...
			Pixastic.process(document.getElementById("channel-2-img"), "apply_greyscale_threshold", {
			...
			Pixastic.process(document.getElementById("channel-22-img"), "apply_greyscale_threshold", {
				threshold: $("#value-threshold-2").val()
			});
		...
		function demo3() {
			...
			Pixastic.process(document.getElementById("channel-3-img"), "apply_greyscale_threshold", {
			...
			Pixastic.process(document.getElementById("channel-33-img"), "apply_greyscale_threshold", {
				threshold: $("#value-threshold-3").val()
			});
		...
		function demo4() {
			...
			Pixastic.process(document.getElementById("channel-4-img"), "apply_greyscale_threshold", {
			...
			Pixastic.process(document.getElementById("channel-44-img"), "apply_greyscale_threshold", {
				threshold: $("#value-threshold-4").val()
			});
		...
		function demo5() {
			...
			Pixastic.process(document.getElementById("channel-5-img"), "apply_greyscale_threshold", {
			...
			Pixastic.process(document.getElementById("channel-55-img"), "apply_greyscale_threshold", {
				threshold: $("#value-threshold-5").val()
			});
		...
		function demo6() {
			...
			Pixastic.process(document.getElementById("channel-6-img"), "apply_greyscale_threshold", {
			...
			Pixastic.process(document.getElementById("channel-66-img"), "apply_greyscale_threshold", {
				threshold: $("#value-threshold-6").val()
			});
		...
		function demo7() {
			...
			Pixastic.process(document.getElementById("channel-7-img"), "apply_greyscale_threshold", {
			...
			Pixastic.process(document.getElementById("channel-77-img"), "apply_greyscale_threshold", {
				threshold: $("#value-threshold-7").val()
			});
		...
		function demo8() {
			...
			Pixastic.process(document.getElementById("channel-8-img"), "apply_greyscale_threshold", {
			...
			Pixastic.process(document.getElementById("channel-88-img"), "apply_greyscale_threshold", {
				threshold: $("#value-threshold-8").val()
			});
		...
		function demo9() {
			...
			Pixastic.process(document.getElementById("channel-9-img"), "apply_greyscale_threshold", {
			...
			Pixastic.process(document.getElementById("channel-99-img"), "apply_greyscale_threshold", {
				threshold: $("#value-threshold-9").val()
			});
		...
		?>
		<?php if (isset($_GET["slide-index-10"])) { 
			if ((int)$_GET["slide-index-10"] > 0) {
		?>
		...
		$(document).ready(function(){
			...
			$("#slider-file").slider({
				slide: function() {
					$("#slide-index-10").val(($("#slider-file").slider("value") * 0.5).toFixed(0));
					$('#filename').val($('#filename').val()+'z'+($("#slider-file").slider("value") * 0.5).toFixed(0));
					alert ($('#oldslideindex').val());
					alert (($("#slider-file").slider("value") * 0.5));
					if ($('#oldslideindex').val() != ($("#slider-file").slider("value") * 0.5)) {
						frmfile.submit();					
					}
				}, value : (<?php echo (int)$_GET["slide-index-10"]; ?> * 2)
			}).slider("moveTo", <?php echo (int)$_GET["slide-index-10"]; ?> * 2);				  
		});		
		</script>
		<?php 
			  }
		...
		<div class="stack s1">
			...
			<?php
				...
				if((isset($_GET['dirname']) &&  $_GET['dirname']!= '') || (isset($_GET['filename']) &&  $_GET['filename']!= '')) {
					echo "<input type='hidden' id='oldslideindex' value='".$slideindex."'>";
					echo "<form method='get' name='frmfile' action=''><div>Slide No: <input type='text' style='width:30px;' class='demo-input' value='0' id='slide-index-10' name='slide-index-10'></div>
					<div style='width:150px;margin-top:5px;margin-bottom:5px;' class='ui-slider' id='slider-file'>
